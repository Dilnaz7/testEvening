competitors = {'Usain': 1, 'Me': 2, 'Aybek':3}
places = {1: 'Usain', 2:'Me', 3:'Aybek'}

def choice_to_number(choice):return competitors[choice]

# If choice is Usain you should get back 1.
def number_to_choice(number): return places[number]
